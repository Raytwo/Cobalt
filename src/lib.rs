...
pub fn il2cpp_init_hook(domain_name: *const i8) -> i32 {
    ...
    skyline::install_hooks!(
        ...
        cobalt::load_default_sound_banks,
        cobalt::wwise_file_open_hook,
        // cobalt::wwise_set_state,
        cobalt::gamesound_personvoice,
        cobalt::unitinfo_reservecharavoice,
        cobalt::gamesound_ringcleaningvoice,
        cobalt::soundmanager_postevent_with_temporarygameobject,
        cobalt::soundplay_posteventcallback,
        cobalt::gamesound_unitpickvoice,
        cobalt::filehandle_loadasync,
        // cobalt::gamesound_postevent2,
        // cobalt::soundmanager_postevent,
        // cobalt::soundmanager_postevent2,
        cobalt::soundmanager_iseventplaying,
